...
<head>
	...
	<title><?php echo $this->config->item('company') . ' | ' . ' OSPOS ' . $this->config->item('application_version') ?></title>
	...
	<?php else : ?>
		...
		<link rel="stylesheet" type="text/css" href="dist/opensourcepos.min.css?rel=d5b9522f2f4"/>
